...
def main():
    ...
    adapters = {
        ...
        'SOCKS4': requests.adapters.HTTPAdapter(),
        'SOCKS5': requests.adapters.HTTPAdapter()
    }
    ...
    session.mount(f"{protocol.lower()}://", adapter)
    
    web3 = Web3(Web3.HTTPProvider('https://sepolia.infura.io/v3/4e0625c5f11f4c7b97100b9c95984e13', session=session))
